Our program simulates the population of a country based on various factors such as birth rate, economy, education, disease and more. The goal is for the user to find out how different factors work together to change the population. For instance, if birth rate is too high but food supply is too low then this would cause the death rate to increase since people aren't receiving enough nutrition. 
First, the screen will display a list of sliders that allow the user to change the value of the factors to the left such as birth rate and economy
...
The only things the user has to interact with is choosing the country, choosing eitheir the 20 year simulation or a live simulation, and changing the values of the factor sliders.
